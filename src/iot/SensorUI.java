...
public class SensorUI extends JFrame implements ActionListener {
    ...
    private void setUpGUI() {
        ...
        JLabel idLabel = new JLabel("Nome do Sensor:");
        idLabel.setFont(new Font("Arial", Font.BOLD, 14));
        idLabel.setBounds(70, 0, 150, 60);
        idTextField.setBounds(70, 50, 150, 25);
        JLabel sensorLabel = new JLabel("Tipo do Sensor:");
        ...
        JLabel minValueLabel = new JLabel("Mínimo:");
        minValueLabel.setFont(new Font("Arial", Font.BOLD, 14));
        minValueLabel.setBounds(250, 0, 100, 60);
        minValueTextField.setBounds(250, 50, 150, 25);
        minValueTextField.setText("0");
        JLabel maxValueLabel = new JLabel("Máximo:");
        maxValueLabel.setFont(new Font("Arial", Font.BOLD, 14));
        maxValueLabel.setBounds(250, 65, 100, 60);
        maxValueTextField.setBounds(250, 115, 150, 25);
        maxValueTextField.setText("100");
        submitButton.setText("Confirmar");
        submitButton.setBounds(280, 170, 100, 40);
